...
- [0933 Number of Recent Calls](codes_/0933_Number_of_Recent_Calls.py) - ([leetcode.com](https://leetcode.com/problems/number-of-recent-calls/))
- [0937 Reorder Data in Log Files](codes_/0937_Reorder_Data_in_Log_Files.py) - ([leetcode.com](https://leetcode.com/problems/reorder-data-in-log-files/))
- [0938 Range Sum of BST](codes_/0938_Range_Sum_of_BST.py) - ([leetcode.com](https://leetcode.com/problems/range-sum-of-bst/))
- [0941 Valid Mountain Array](codes_/0941_Valid_Mountain_Array.py) - ([leetcode.com](https://leetcode.com/problems/valid-mountain-array/))
- [0942 *DI String Match](codes_/0942_DI_String_Match.py) - ([leetcode.com](https://leetcode.com/problems/di-string-match/))
- [0944 Delete Columns to Make Sorted](codes_/0944_Delete_Columns_to_Make_Sorted.py) - ([leetcode.com](https://leetcode.com/problems/delete-columns-to-make-sorted/))
- [0953 Verifying an Alien Dictionary](codes_/0953_Verifying_an_Alien_Dictionary.py) - ([leetcode.com](https://leetcode.com/problems/verifying-an-alien-dictionary/))
- [0961 N-Repeated Element in Size 2N Array](codes_/0961_NRepeated_Element_in_Size_2N_Array.py) - ([leetcode.com](https://leetcode.com/problems/n-repeated-element-in-size-2n-array/))
- [0965 Univalued Binary Tree](codes_/0965_Univalued_Binary_Tree.py) - ([leetcode.com](https://leetcode.com/problems/univalued-binary-tree/))
...
- [0999 Available Captures for Rook](codes_/0999_Available_Captures_for_Rook.py) - ([leetcode.com](https://leetcode.com/problems/available-captures-for-rook/))
...
- [1018 Binary Prefix Divisible By 5](codes_/1018_Binary_Prefix_Divisible_By_5.py) - ([leetcode.com](https://leetcode.com/problems/binary-prefix-divisible-by-5/))
- [1021 Remove Outermost Parentheses](codes_/1021_Remove_Outermost_Parentheses.py) - ([leetcode.com](https://leetcode.com/problems/remove-outermost-parentheses/))
- [1022 Sum of Root To Leaf Binary Numbers](codes_/1022_Sum_of_Root_To_Leaf_Binary_Numbers.py) - ([leetcode.com](https://leetcode.com/problems/sum-of-root-to-leaf-binary-numbers/))
- [1025 Divisor Game](codes_/1025_Divisor_Game.py) - ([leetcode.com](https://leetcode.com/problems/divisor-game/))
- [1030 Matrix Cells in Distance Order](codes_/1030_Matrix_Cells_in_Distance_Order.py) - ([leetcode.com](https://leetcode.com/problems/matrix-cells-in-distance-order/))
- [1033 Moving Stones Until Consecutive](codes_/1033_Moving_Stones_Until_Consecutive.py) - ([leetcode.com](https://leetcode.com/problems/moving-stones-until-consecutive/))
...
- [1051 Height Checker](codes_/1051_Height_Checker.py) - ([leetcode.com](https://leetcode.com/problems/height-checker/))
- [1071 Greatest Common Divisor of Strings](codes_/1071_Greatest_Common_Divisor_of_Strings.py) - ([leetcode.com](https://leetcode.com/problems/greatest-common-divisor-of-strings/))
- [1078 Occurrences After Bigram](codes_/1078_Occurrences_After_Bigram.py) - ([leetcode.com](https://leetcode.com/problems/occurrences-after-bigram/))
- [1089 Duplicate Zeros](codes_/1089_Duplicate_Zeros.py) - ([leetcode.com](https://leetcode.com/problems/duplicate-zeros/))
- [1103 Distribute Candies to People](codes_/1103_Distribute_Candies_to_People.py) - ([leetcode.com](https://leetcode.com/problems/distribute-candies-to-people/))
...
- [1122 Relative Sort Array](codes_/1122_Relative_Sort_Array.py) - ([leetcode.com](https://leetcode.com/problems/relative-sort-array/))
- [1128 Number of Equivalent Domino Pairs](codes_/1128_Number_of_Equivalent_Domino_Pairs.py) - ([leetcode.com](https://leetcode.com/problems/number-of-equivalent-domino-pairs/))
- [1137 *N-th Tribonacci Number](codes_/1137_Nth_Tribonacci_Number.py) - ([leetcode.com](https://leetcode.com/problems/n-th-tribonacci-number/))
- [1154 Day of the Year](codes_/1154_Day_of_the_Year.py) - ([leetcode.com](https://leetcode.com/problems/day-of-the-year/))
- [1160 Find Words That Can Be Formed by Characters](codes_/1160_Find_Words_That_Can_Be_Formed_by_Characters.py) - ([leetcode.com](https://leetcode.com/problems/find-words-that-can-be-formed-by-characters/))
- [1170 *Compare Strings by Frequency of the Smallest Character](codes_/1170_Compare_Strings_by_Frequency_of_the_Smallest_Character.py) - ([leetcode.com](https://leetcode.com/problems/compare-strings-by-frequency-of-the-smallest-character/))
- [1175 Prime Arrangements](codes_/1175_Prime_Arrangements.py) - ([leetcode.com](https://leetcode.com/problems/prime-arrangements/))
- [1184 Distance Between Bus Stops](codes_/1184_Distance_Between_Bus_Stops.py) - ([leetcode.com](https://leetcode.com/problems/distance-between-bus-stops/))
- [1185 Day of the Week](codes_/1185_Day_of_the_Week.py) - ([leetcode.com](https://leetcode.com/problems/day-of-the-week/))
- [1189 *Maximum Number of Balloons](codes_/1189_Maximum_Number_of_Balloons.py) - ([leetcode.com](https://leetcode.com/problems/maximum-number-of-balloons/))
- [1200 Minimum Absolute Difference](codes_/1200_Minimum_Absolute_Difference.py) - ([leetcode.com](https://leetcode.com/problems/minimum-absolute-difference/))
- [1207 Unique Number of Occurrences](codes_/1207_Unique_Number_of_Occurrences.py) - ([leetcode.com](https://leetcode.com/problems/unique-number-of-occurrences/))
- [1217 Minimum Cost to Move Chips to The Same Position](codes_/1217_Minimum_Cost_to_Move_Chips_to_The_Same_Position.py) - ([leetcode.com](https://leetcode.com/problems/minimum-cost-to-move-chips-to-the-same-position/))
